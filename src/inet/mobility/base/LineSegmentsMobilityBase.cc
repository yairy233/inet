...
void LineSegmentsMobilityBase::setInitialPosition()
{
...
void LineSegmentsMobilityBase::move()
{
    ...
    if (now == nextChange) {
        ...
        lastPosition = startPosition + ((targetPosition - startPosition) / (nextChange - startPositionTime).dbl()) * (now - startPositionTime).dbl();
    }
}
