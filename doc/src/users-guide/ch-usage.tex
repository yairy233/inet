...
folders under \ttt{src/}. Packages in INET are organized roughly according 
to OSI layers. The top packages are:

\begin{itemize}
  \item \ttt{inet.applications}
  \item \ttt{inet.transportlayer}
  \item \ttt{inet.networklayer}
  \item \ttt{inet.linklayer}
  \item \ttt{inet.physicallayer}
\end{itemize}

Other packages are:

\begin{itemize}
  \item \ttt{inet.routing}
  \item \ttt{inet.mobility}
  \item \ttt{inet.power} 
  \item \ttt{inet.environment},
  \item \ttt{inet.node}. 
\end{itemize}
...
package, as defined by the \ttt{src/inet/package.ned} file.)
